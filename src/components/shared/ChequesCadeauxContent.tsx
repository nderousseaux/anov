...
export function ChequesCadeauxContent({
  content,
}: {
  content?: ChequesCadeauxContent | null;
}) {
      ...
      <section className="py-16 md:py-20 px-4 bg-card">
        <div className="max-w-3xl mx-auto">
          ...
          <form
            ...
            className="bg-secondary p-8 rounded-lg border border-primary/30 space-y-6"
          >
            <div className="space-y-2">
              ...
              >
                <SelectTrigger className="bg-background/30 border-primary/30 text-foreground">
                  <SelectValue
                    placeholder={pickField(c, "placeholderAmount", locale)}
                  />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setGiftCard({ ...giftCard, recipient: e.target.value })
                }
            ...
            <div className="flex-col">
              ...
              <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground">
                <span>
                  {pickField(c, "footerSecure", locale)} •{" "}
                  {pickField(c, "footerValid", locale)}
                </span>
              </div>
            </div>
          </form>
