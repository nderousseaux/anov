      ...
      <div className="relative h-[15vh] sm:h-[40vh]">
        <Image
          src={
            ...
            "https://images.unsplash.com/photo-1758612798971-a8adb6cba7eb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXN0YXVyYW50JTIwaW50ZXJpb3IlMjBhdG1vc3BoZXJlJTIwbGlnaHRpbmd8ZW58MXx8fHwxNzcxNTE0NjAwfDA&ixlib=rb-4.1.0&q=80&w=1080"
          }
          alt="Contact"
          fill
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-12">
            ...
            <div className="h-full">
              <form
                ...
                className="bg-secondary p-5 sm:p-8 rounded-lg border border-primary/30 flex flex-col gap-4 sm:gap-6 h-full"
              >
            ...
            <div className="grid grid-cols-2 gap-4 lg:flex lg:flex-col lg:justify-between lg:gap-6 h-full">
              ...
              <div className="bg-secondary p-4 sm:p-6 rounded-lg border border-primary/30">
                ...
                <p className="text-foreground text-sm sm:text-base">
                  <a
                    href={`tel:${(c.phone as string | null | undefined) ?? "+33145678900"}`}
                    className="hover:text-primary transition-colors"
                  >
                    {(c.phone as string | null | undefined) ??
                      "+33 1 45 67 89 00"}
                  </a>
                </p>
              </div>
              ...
              <div className="bg-secondary p-4 sm:p-6 rounded-lg border border-primary/30">
                ...
                <p className="text-foreground text-sm sm:text-base">
                  <a
                    href={`mailto:${(c.email as string | null | undefined) ?? "contact@anovrestaurant.fr"}`}
                    className="hover:text-primary transition-colors"
                  >
                    {(c.email as string | null | undefined) ??
                      "contact@anovrestaurant.fr"}
                  </a>
                </p>
              </div>
              ...
              <div className="col-span-2 bg-secondary p-4 sm:p-6 rounded-lg border border-primary/30">
                ...
                >
                  {(c.address as string | null | undefined) ??
              ...
              <Button
                onClick={() =>
                  window.open(
                    (c.mapsUrl as string | null | undefined) ??
