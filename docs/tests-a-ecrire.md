...
```typescript
-Navbar.tsx - NavbarDropdown.tsx - Footer.tsx - LanguageSelector.tsx;
```
...
```typescript
-src / app / api / admin / gift -
  cards / route.ts(GET, POST, PATCH) -
...
-src / app / reservation / succes / page.tsx -
  ...
  src / app / cheques -
  cadeaux / succes / page.tsx -
  src / app / cheques -
  cadeaux / succes / GiftCardSuccessContent.tsx;
```
...
_Document généré le 2026-07-12_
