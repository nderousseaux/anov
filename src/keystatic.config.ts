  ...
  singletons: {
    ...
    boutique: singleton({
      ...
      schema: {
        ...
        giftCardsIntroTitle_fr: fields.text({ label: 'Chèques Cadeaux — Intro Titre 🇫🇷' }),
        giftCardsIntroTitle_en: fields.text({ label: 'Chèques Cadeaux — Intro Titre 🇬🇧' }),
        giftCardsIntroTitle_de: fields.text({ label: 'Chèques Cadeaux — Intro Titre 🇩🇪' }),
        giftCardsIntroText_fr: fields.text({ label: 'Chèques Cadeaux — Intro Text 🇫🇷', multiline: true }),
        giftCardsIntroText_en: fields.text({ label: 'Chèques Cadeaux — Intro Text 🇬🇧', multiline: true }),
        giftCardsIntroText_de: fields.text({ label: 'Chèques Cadeaux — Intro Text 🇩🇪', multiline: true }),
        ...
        productsIntroSubtitle_fr: fields.text({ label: 'Produits — Sous-titre 🇫🇷' }),
        productsIntroSubtitle_en: fields.text({ label: 'Produits — Sous-titre 🇬🇧' }),
        productsIntroSubtitle_de: fields.text({ label: 'Produits — Sous-titre 🇩🇪' }),
